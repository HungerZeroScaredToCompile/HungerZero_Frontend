    ...
    return (
      <div className="relative bg-whitesmoke-100 w-full h-[1484px] overflow-hidden text-left text-smi text-seagreen-100 font-poppins ">
       ...
       <img
        ...
        <div className='ml-[1090px] mt-[14px] flex flex-row justify-between'>
          <Link to={"/userhome"} ><p className='m-2 font-extrabold'>
                Home
            </p></Link> 
            <p className='m-2'>
                Donation
...
{/* Card*/}
      ...
      <div className="mt-4">
        ...
        <button className=" ml-16 mt-4 bg-[#06906F] cursor:pointer text-white w-[120px] font-bold h-10 rounded-full">
          Donate Now
        </button>
        </div>
