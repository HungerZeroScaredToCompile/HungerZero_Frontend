...
const NgoRegister = () => {
  ...
  const isInvalid = password === "" || companyname === "" || email === "" || companydomain === "" || username === ""  || address === "";
  ...
  return (
   ...
   Create Account
      ...
      <p className='' >Already have an account? <Link to='/ngologin'> <button className='bg-transparent'    >Sign in</button></Link></p>
      </div>
    </div>
